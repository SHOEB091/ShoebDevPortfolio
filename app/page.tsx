              ...
              <GlassmorphicCard>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="space-y-1">
                    ...
                    <div className="font-medium">shoeb iqbal</div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-sm text-zinc-500">Email</div>
                    <div className="font-medium">wiqbal091@gmail.com</div>
                  </div>
                  <div className="space-y-1">
      ...
      <section id="projects" className="py-32 relative">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            ...
            />
            <ProjectCard
              title="MultiPlatform HRMS Application"
              description="A comprehensive Human Resource Management System built with Flet, Python, and SQLite, deployed across Android, Windows, Linux, and macOS platforms. This enterprise-grade application streamlines HR operations with role-based access control, secure authentication using PBKDF2 hashing, and modern UI components. Features include employee management, attendance tracking with automatic hour calculation, leave management, salary processing, and interactive analytics dashboards. Implemented responsive design principles and platform-specific optimizations, reducing administrative workload by 60% while maintaining 99.8% feature consistency across all devices. Enhanced security with input validation, session management, and audit logging, resulting in zero security incidents since deployment and a 45% improvement in HR team productivity."
            ...
            <ProjectCard
              ...
              description="Executed a robust AI backend with Python and AWS services (Lambda, API Gateway, S3), reducing operational
costs by 30%.
• Developed a responsive UI using React.js and Chakra UI, ensuring cross-platform compatibility and 99.9%
uptime.
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-medium">github.com/SHOEB091/</div>
                  </div>
                </div>
              </div>
        ...
        <div className="container flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-sm text-zinc-500 mt-2">
              © {new Date().getFullYear()} shoeb iqbal. All rights reserved.
            </p>
          </div>
